...
from .fofe_modules import fofe_flex_dual_linear, fofe_encoder_conv, fofe_block, fofe_res_block, fofe_encoder, fofe_linear_tricontext
...
class FOFEReader(nn.Module):
    def __init__(self, opt, padding_idx=0, embedding=None):
        ...
        #----------------------------------------------------------------------------
        self.fofe_encoder = fofe_encoder_conv(doc_input_size, opt['hidden_size'], opt['fofe_alpha']-0.4, opt['fofe_alpha'],  opt['fofe_max_length'])
        ...
        self.fofe_linear = fofe_flex_dual_linear(opt['embedding_dim'], opt['hidden_size'], opt['fofe_alpha']-0.4, opt['fofe_alpha'])
