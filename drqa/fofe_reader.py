...
from .fofe_modules import fofe_flex, fofe, fofe_block, fofe_res_block, fofe_encoder, fofe_linear_tricontext
...
class FOFEReader(nn.Module):
    def __init__(self, opt, padding_idx=0, embedding=None):
        ...
        self.fofe_linear = fofe_flex(opt['embedding_dim'], opt['fofe_alpha'])
        """
